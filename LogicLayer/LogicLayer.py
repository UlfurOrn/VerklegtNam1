...
class LogicLayer:
    ...
    def in_use(self, asset):
        return self.is_busy_during_period(asset, datetime.now(), datetime.now())
    ...
    def is_busy_during_period_str(self, asset, departure_str, arrival_str):
        return (self.str_to_datetime(departure_str), self.str_to_datetime(arrival_str))

    def is_busy_during_period(self, asset, departure_time, arrival_time):
